...
python -u train.py --name raft-kitti  --stage kitti --validation kitti --restore_ckpt E:\RAFT\Pretrained_model\raft-kitti.pth --small --gpus 0 1 --num_steps 50000 --batch_size 1 --lr 0.0001 --image_size 288 960 --wdecay 0.00001 --gamma=0.85
